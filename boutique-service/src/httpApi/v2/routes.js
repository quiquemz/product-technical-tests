export default function attachRoutes({ models, router, handlers }) {
    ...
    /**
     * @api {get} /v2/boutiques/:slug Returns boutique for given slug
     * @apiName Boutique
     * @apiGroup Boutiques
     * @apiVersion 2.0.0
     *
     * @apiDescription Returns boutique for given slug
     *
     ...
     *
     */
    router.get('/boutiques/:slug', handlers.boutique.bind(undefined, {models}));

    /**
     * @api {get} /v2/boutiques Return a list of all boutiques
     ...
     *
     */
    router.put('/boutiques/:slug', handlers.updateBoutique.bind(undefined, {models}));

    /**
     * @api {get} /v2/boutiques/near Return the boutiques closest to provided coordinates
